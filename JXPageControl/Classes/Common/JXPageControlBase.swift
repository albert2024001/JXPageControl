...
@IBDesignable open class JXPageControlBase: UIView, JXPageControlType {
    ...
    var maxIndicatorSize: CGSize = .init(width: 2, height: 2)

    var minIndicatorSize: CGSize = .init(width: 2, height: 2)
    ...
    func updateProgress(_: CGFloat) {}

    func updateCurrentPage(_: Int) {}
